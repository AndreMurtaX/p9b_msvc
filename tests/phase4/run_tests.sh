...
# Usage: bash tests/phase4/run_tests.sh [path/to/p9b.exe]
...
echo "=== Phase 4: Advanced Strings ==="

run_test t01_format.bas  "FORMAT\$ numeric"   "$(printf '  3.14\n1,234.50\n -42.00')"
run_test t02_space.bas   "SPACE\$(n)"         "$(printf '5\n[   ]')"
run_test t03_string_n.bas "STRING\$(n,c\$)"   "$(printf '*****\nAAAA')"
