...
# Usage: bash tests/phase6/run_tests.sh [path/to/p9b.exe]
...
echo "=== Phase 6: Interactivity ==="

# t01: TIMER returns a non-negative number
run_test t01_timer.bas      "TIMER >= 0"         "1"

# t02: LOCATE and COLOR produce output containing "ok"
run_test t02_locate_color.bas "LOCATE/COLOR"     "" "ok"

# t03: COLOR with bg component works
run_test t03_color_bg.bas   "COLOR with bg"      "" "ok"
